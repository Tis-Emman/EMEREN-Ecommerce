        ...
        >
          ...
          >
            ...
            <nav
              ...
              style={{ alignItems: "center", gap: "28px", justifyContent: "center" }}
            >
              {[
              ...
              {user ? (
                ...
                <>
                  <Link
                    ...
                    style={{ padding: "8px 18px", fontSize: "13px", fontWeight: 600, textDecoration: "none", alignItems: "center" }}
                  >
                    Sign In
                  </Link>
                  <Link
                    ...
                    style={{ padding: "9px 20px", fontSize: "13px", textDecoration: "none", alignItems: "center", gap: "6px" }}
                  >
                    Get Started
                    <ArrowRight size={13} />
                  </Link>
          ...
          <div className="mobile-nav" role="dialog" aria-modal="true" aria-label="Navigation menu">
            ...
            <div className="mobile-nav-header">
              ...
              >
                ...
                <span className="brand" style={{ color: "#1a1a2e", fontSize: "18px", fontWeight: 800, letterSpacing: "-0.5px" }}>EMEREN</span>
              </Link>
              <button
                onClick={() => setMobileNavOpen(false)}
                style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "36px", height: "36px", borderRadius: "10px", border: "1.5px solid rgba(0,0,0,0.1)", background: "transparent", cursor: "pointer" }}
              ...
              {user && (
                <>
                  ...
                  <Link
                    ...
                    style={{ textDecoration: "none" }}
                  >
                    <span className="link-icon"><User size={16} color="#d97706" /></span>
                    My Profile
                  </Link>
                </>
              )}
              ...
              {!user ? (
                <>
                  <Link
                    ...
                    className="cta-btn"
                    onClick={() => setMobileNavOpen(false)}
                    style={{ padding: "13px 20px", fontSize: "14px", textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", gap: "7px", borderRadius: "12px" }}
                  >
                  ...
                  <Link
                    ...
                    className="ghost-btn"
                    onClick={() => setMobileNavOpen(false)}
                    style={{ padding: "12px 20px", fontSize: "14px", fontWeight: 600, textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "12px" }}
                  >
                    Sign In
                  </Link>
                </>
                ...
                <button
                  ...
                  style={{ width: "100%", padding: "13px 20px", fontSize: "14px", fontWeight: 600, border: "1.5px solid rgba(239,68,68,0.25)", color: "#ef4444", borderRadius: "12px", background: "rgba(239,68,68,0.04)", cursor: "pointer", fontFamily: "'Plus Jakarta Sans', sans-serif", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", transition: "background .15s" }}
